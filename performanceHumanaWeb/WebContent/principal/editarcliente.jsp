          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-11 col-xl-9">
              <section class="py-4 py-lg-5">
              	<p class="h4 text-center">Editar Cliente</p>
              	<hr>
                <form class="mt-0"  action="ServletCliente" method="post">
						 <input type="hidden" class="form-control"  name="txtCodCliente"  value="${cliente.codCliente}">
