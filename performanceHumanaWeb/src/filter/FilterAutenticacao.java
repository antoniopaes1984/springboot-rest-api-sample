...
public class FilterAutenticacao implements Filter {
	...
	//Intecerpeta as requisições e as respostas no sistema
	//tudo que fizer no sistema passa por aqui. ex: validação de autenticação, dar commit e rolback no banco, validar e fazer redirecionamento
